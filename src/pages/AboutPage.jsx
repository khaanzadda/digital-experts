...
export default function AboutPage() {
  useMeta({
    title: "About — DigitalExperts",
    description:
      "Learn about DigitalExperts: our mission, process, and why teams choose us for premium web, Shopify, WordPress, and SaaS development.",
  });
        ...
        <div className="rounded-3xl border border-white/10 bg-gradient-to-r from-white/10 to-white/5 p-10 shadow-soft sm:p-14">
          <div className="max-w-2xl">
            ...
            <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-white sm:text-5xl">
              A premium, product-minded agency
            </h1>
            <p className="mt-4 text-base leading-7 text-slate-200/90">
              DigitalExperts partners with modern teams to build digital products that
              look exceptional and perform at scale.
            </p>
          </div>
        </div>
      </div>
