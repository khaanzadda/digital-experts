...
export default function TestimonialsPage() {
  useMeta({
    title: "Testimonials - DigitalExperts",
    description:
      "Read client feedback for DigitalExperts web, Shopify, WordPress, and SaaS product work.",
  });
        ...
        <div className="rounded-3xl border border-white/10 bg-gradient-to-r from-white/10 to-white/5 p-10 shadow-soft sm:p-14">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-base leading-7 text-slate-200/90">
              A few words from founders and teams who trusted DigitalExperts with
              design, development, and production delivery.
            </p>
          </div>
        </div>
      </div>
